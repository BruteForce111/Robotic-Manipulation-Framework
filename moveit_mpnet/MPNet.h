    ...
    namespace geometric
    {
        ...
        public:
            ...
            */
            ...
            void frankaToMoveIt(torch::Tensor franka_state_tensor, base::State *moveit_state);

            void frankaToMoveItAndUnnormalize(torch::Tensor franka_state_tensor, base::State *moveit_state, const float jointRange[], int dim);

            std::vector<float> moveItToFranka(std::vector<float> moveit_state_vector);
            ...
            std::vector<float> moveItToFrankaAndNormalize(std::vector<float> moveit_state_vector, const float jointRange[], int dim);
            ...
            // void setFrankaJointRange(){
            //     frankaJointRange_ = {3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
            // }

            // static constexpr const float frankaJointRange_[] = {3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
            // const float frankaJointRange[7]{3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
            // const float frankaJointRange[7] = {3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
        ...
        protected:
            ...
            //MPNet 
            // const float frankaJointRange[7]{3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
            // float frankaJointRange_[7] = {3.4033, 3.194, 6.1083, 2.67, 6.117, 3.6647, 6.117};
        };
    }
}
